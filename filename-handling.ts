export function determineOutputFilename(filename: string): string | null {
  ...
  const goodKnownPrefixes = [
    ...
    /^Tokens\/Heroes\/([A-Z][a-z]+folk|Catch-All_Heroes|Centaur|Dragonborn|Dwarf|Elf|Firbolg|Froglin|Gnome|Goliath|Halfling|Half_Elf|Half_Orc|Human|Gnoll|Kenku|Kitsune|Kobold|Planetouched|Satyr|Tabaxi|Tiefling|Tortle|Trollkin|Warforged)\//,
